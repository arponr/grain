...
\usepackage[largesc, scaled=0.96]{newpxtext}
\usepackage[bigdelims, scaled=0.96]{newpxmath}
\useosf
\usepackage[%
  cal=euler,   calscaled=0.98,%
  scr=boondox, scrscaled=1.0,%
...
\titleformat{\section}{}{\llap{{\small\S}\,\thesection\hspace{\tagsep}}}{0em}{%
  \fontsize{10.5}{12}\selectfont\scshape\MakeLowercase}
...
\def\swappedhead#1#2#3{%
 \llap{\thmnumber{\@upn{{\thmnumfont#2}}\hspace{\tagsep}}}%
  \thmname{\thmheadfont#1}%
  \@ifnotempty{#3}{\hspace{\thmnotespace}\thmnote{\thmnotefont(#3)}}%
}
\swapnumbers
...
\newtheoremstyle{block}%
  ...
  {} % Indent amount
  {} % Theorem head font
  {\thmsep} % Punctuation after theorem head
