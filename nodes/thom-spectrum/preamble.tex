...
\newcommand{\thmlabelspace}{0.25em}
\newcommand{\thmnotespace}{0.25em}

\def\swappedhead#1#2#3{%
  \thmnumber{\@upn{{\thmnumfont#2}}\@ifnotempty{#1}{.\hspace{\thmlabelspace}}}%
  \thmheadfont\thmname{#1}%
...
\newcommand{\externalgrain}[1]{
  ...
  \externalcrefeqfmt{#1}{situtation}
...
\setlist[enumerate, 1]{%
  leftmargin=*,%
  label=(\theequation.\arabic*),%
  ref=\theequation.\arabic*,%
}
\setlist[enumerate, 2]{%
  leftmargin=*,%
